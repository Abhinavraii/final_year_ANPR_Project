...
#         arduino.write(b'1')
#         st.write("Gate is Opened")

#     if st.button('Close Gate'):
#         arduino.write(b'0')
#         st.write("Gate is Closed")

#     # Close the serial connection when the app is stopped
    ...
    for box in boxes:
        ...
        if 2.5 < aspect_ratio < 8:
            ...
            if license_plate is not None:
                ...
                # Send signal to the Arduino based on the status
                if arduino:
                    if status == "Vehicle from inside (allow vehicle)":
                        arduino.write(b'1')
                    else:
                        arduino.write(b'0')
